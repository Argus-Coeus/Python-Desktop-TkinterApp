...
logout_text = Button(header,text="Logout",bg="#eff5f6",font=("",13,"bold"),bd=0,fg="black",
                             cursor="hand2",activebackground="#0064d3")
...
manage_text.place(x=80, y=345)
        ...
        # Settings
searchImage = Image.open("images/settings-icon.png")
